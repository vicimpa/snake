import { Cyan, Green, Red, Reset } from "./Colors";
...
export class ConsoleRenderer extends BaseRenderer {
  ...
  render() {
    ...
    const horisontalRow = horisontal.map(_ => '─').join('─');
    ...
    if (this.extended) {
      Range.go(score, 0).map(e => {
        ...
        switch (position) {
          case 0b0010: directions[e] = DirectionBlock.LEFT; break;
          case 0b0001: directions[e] = DirectionBlock.RIGHT; break;
          case 0b0011: directions[e] = DirectionBlock.HORIZONTAL; break;
          case 0b1000: directions[e] = DirectionBlock.TOP; break;
          case 0b0100: directions[e] = DirectionBlock.BOTTOM; break;
          case 0b1100: directions[e] = DirectionBlock.VERTICAL; break;
          case 0b1001: directions[e] = DirectionBlock.TOP_LEFT; break;
          case 0b1010: directions[e] = DirectionBlock.TOP_RIGHT; break;
          case 0b0101: directions[e] = DirectionBlock.BOTTOM_LEFT; break;
          case 0b0110: directions[e] = DirectionBlock.BOTTOM_RIGHT; break;
        }
      });
    }
      ...
      let rowString = row.map((v, x) => {
        ...
        if (this.extended) {
          switch (directions[val]) {
            case DirectionBlock.TOP: symbol = '║'; break;
            case DirectionBlock.BOTTOM: symbol = '║'; break;
            case DirectionBlock.LEFT: symbol = '═'; break;
            case DirectionBlock.RIGHT: symbol = '═'; break;
            case DirectionBlock.VERTICAL: symbol = '║'; break;
            case DirectionBlock.HORIZONTAL: symbol = '═'; break;
            case DirectionBlock.TOP_LEFT: symbol = '╗'; break;
            case DirectionBlock.TOP_RIGHT: symbol = '╔'; break;
            case DirectionBlock.BOTTOM_LEFT: symbol = '╝'; break;
            case DirectionBlock.BOTTOM_RIGHT: symbol = '╚'; break;
          }
        }
        ...
        if (val == maxScore || valNex == maxScore)
          return `${e} `;

        if (val - valNex != 1 && valNex - val !== 1)
          return `${e} `;
